...
--file-read='<file_path>'
to read a file from the target system.

--file-write='<local_file>' --file-dest='<remote_file>'
to write a local file to the target system.

--os-shell
to get an interactive operating system shell on the target system.